...
"C:\ffmpeg\bin\ffmpeg.exe" -rtsp_transport tcp -i "%RTSP_URL%" -c:v libx264 -preset veryfast -f hls -hls_time 2 -hls_list_size 5 -hls_flags delete_segments "%OUTPUT_DIR%\index.m3u8" > "%OUTPUT_DIR%\ffmpeg_output.log" 2>&1
