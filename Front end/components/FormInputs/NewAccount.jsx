...
export default function NewEmployee() {
  ...
  const [showPassword, setShowPassword] = useState(false); // حالة جديدة لإظهار/إخفاء كلمة المرور
          ...
          <div>
            ...
            <div className="relative" dir="ltr">
              <input
                ...
                onChange={handleChange}
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-left pr-10"
                required
                minLength="6"
              ...
              <button
                type="button"
                className="absolute inset-y-0 left-0 flex items-center px-3 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 focus:outline-none transition-colors duration-200"
