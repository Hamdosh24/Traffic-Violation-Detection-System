...
export default function CustomDataTable() {
  ...
  return (
    <div className="">
      <h2 className="text-xl font-bold mb-4 p-4 text-slate-800 dark:text-slate-50">
        Reacent Orders
      </h2>
      {/* Table  */}
      <div className="relative overflow-x-auto shadow-xl sm:rounded-md">
          ...
          <tbody>
            {CurrentlyDisplayedData.map((item, i) => {
              return (
                <tr
                  key={i}
                  className="bg-white border-b dark:bg-slate-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600"
                >
